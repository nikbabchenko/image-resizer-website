...
const config = {
    ...
    entry: {
        'index': './index.js',
        'support': './pages/support/support.js',
        'privacy': './pages/privacy/privacy.js',
        '404': './pages/404/404.js',
    },
    output: {
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            chunks: ['support'],
            template: path.join(srcPath, './pages/support/support.pug'),
            filename: 'support.html'
        }),
        new HtmlWebpackPlugin({
            chunks: ['privacy'],
            template: path.join(srcPath, './pages/privacy/privacy.pug'),
            filename: 'privacy.html'
        }),
        new HtmlWebpackPlugin({
            chunks: ['404'],
            template: path.join(srcPath, './pages/404/404.pug'),
            filename: '404.html'
        }),
